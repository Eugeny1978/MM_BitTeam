...
# int (timestamp)
stamp_dt = 1709326856
stamp_dz = datetime.datetime.fromtimestamp(stamp_dt, tz=pytz.utc).strftime(form)[:-3] + 'Z'
...
# date
date_dt = datetime.date(2024, 3, 1)
date_dz = date_dt.strftime(form)[:-3] + 'Z'

# datetime
datetime_dt = datetime.datetime(2024, 3, 1, 11, 7, 16)
datetime_dz = datetime_dt.strftime(form)[:-3] + 'Z'
